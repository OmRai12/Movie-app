export async function getPopularTVShows() {
    const response = await fetch(`https://api.themoviedb.org/3/tv/popular?api_key=d6f2f47bd9efef34b8b55e11b339d2e6`);
    const data = await response.json();
    console.log(data);
    const tvShows = data.results;

    const popularTVShowsList = document.getElementById('popular-tv-list');
